    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "kind": "text",
            "text": "La página 51 tenía dos ejercicios. El 4 era contestar なに を しますか según el momento, cuidando el tiempo verbal."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "⚠️",
            "text": "La pregunta y la respuesta van en el mismo tiempo. きょう y こんばん piden ます; きのう y おととい piden ました."
          },
          {
            "kind": "text",
            "text": "El 5 era preguntar por el lugar con どこ で."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "あいます (encontrarse con alguien) lleva に para la persona, no を: ミラーさん に あいます."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "kind": "note",
            "tone": "⚠️",
            "text": "No confundas へ con で. へ marca a dónde vas, で marca dónde hacés la cosa: デパート へ いきます es \"voy a la tienda\", デパート で かいます es \"compro en la tienda\"."
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "Es la misma で del transporte de la clase 16 (でんしゃ で いきます). Siempre marca el marco en el que pasa la acción: el vehículo o el lugar."
          },
          {
            "kind": "text",
            "text": "Los lugares que ya tenemos para usar con で:"
          },
          {
            "kind": "table",
            "headers": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "kind": "text",
            "text": "それから une dos acciones en el orden en que pasaron: primero una, después la otra. Va al principio de la segunda oración, normalmente con coma."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "Con la rutina del día se encadenan todos los pasos."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "Y con cualquier par de acciones del día."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "El diálogo de la página 53 usa それから para contar el fin de semana."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "たなかさん は？ es la forma corta de devolver la pregunta, el \"¿y vos?\" de toda la vida. Y いい です ね es el comentario de \"qué bueno\" que se espera cuando el otro te cuenta algo."
          },
          {
            "kind": "text",
            "text": "Palabras nuevas que salieron acá:"
          },
          {
            "kind": "table",
            "headers": [
      ...
      },
      {
        ...
        "titleJp": "いつも・ときどき・あまり・ぜんぜん",
        "blocks": [
          {
            "kind": "text",
            "text": "Estos adverbios van después del tema y antes del objeto, y dicen cada cuánto hacés algo. Los dos últimos obligan al verbo a ir en negativo."
          },
          {
            "kind": "table",
            "headers": [
            ...
            "rows": [
              ...
              [
                "あまり",
                "Amari",
                "casi no / no mucho (+ negativo)"
              ],
              [
                "ぜんぜん",
                "Zenzen",
                "nunca / para nada (+ negativo)"
              ]
            ]
          },
          {
            "kind": "text",
            "text": "La clase lo explicó con el calendario de さくらさん."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "⚠️",
            "text": "あまり y ぜんぜん no existen con verbo afirmativo. Nunca digas あまり みます ni ぜんぜん のみます: siempre みません, のみません."
          },
          {
            "kind": "text",
            "text": "Combinados con で arman el par \"lo que hago siempre\" y \"lo que hago a veces\"."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "El otro diálogo de la página 53 junta todo: いつも, ときどき, どこで y も."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "El 〜や del final de まいにちや y フランスや es el sufijo de los negocios: パンや es la panadería, はなや la florería. Son dos panaderías inventadas del libro."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "kind": "text",
            "text": "La forma negativa 〜ません con か deja de ser una pregunta común y pasa a ser una invitación: es el \"¿no querés…?\" del castellano. いっしょに es \"juntos\"."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "Para aceptar hay dos respuestas, y casi siempre van juntas."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "⚠️",
            "text": "すみません、ちょっと… es un no. La frase se deja colgada a propósito: decir \"no\" de frente es brusco en japonés, así que se corta y el otro entiende. Si te contestan eso, no insistas."
          },
          {
            "kind": "text",
            "text": "Las invitaciones que practicamos:"
          },
          {
            "kind": "table",
            "headers": [
            ...
            "rows": [
              ...
              [
                "いっしょに としょかん へ いきませんか？",
                "Issho ni toshokan e ikimasen ka?",
                "¿Vamos a la biblioteca?"
              ],
              [
                "いっしょに びじゅつかん へ いきませんか？",
                "Issho ni bijutsukan e ikimasen ka?",
                "¿Vamos al museo?"
              ],
              [
                "いっしょに テニス を しませんか？",
          ...
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "Con un lugar la partícula sigue siendo へ (としょかん へ いきませんか), porque el verbo es de movimiento. Con una cosa es を."
          },
          {
            "kind": "subheading",
            "text": "〜ましょう"
          ...
          {
            "kind": "text",
            "text": "Una vez que el otro aceptó, 〜ましょう sirve para arreglar los detalles: la hora, el lugar, el día."
          },
          {
            "kind": "quote",
            "lines": [
          ...
          {
            "kind": "text",
            "text": "El diálogo completo de la página 53:"
          },
          {
            "kind": "quote",
            "lines": [
          ...
          },
          {
            "kind": "note",
            "tone": "💡",
            "text": "Esa última frase tiene las tres partículas de la clase juntas: に para la hora, で para el lugar y el verbo en 〜ましょう."
          },
          {
            "kind": "note",
            "tone": "📝",
            "text": "Tarea: みんな の にほんご — ５２ページ ６ と ７, ５４ページ ３ と ４, ５５ページ ５ と ６."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "rows": [
              ...
              [
                "ほん を よみました。それから、ビデオ を みました。",
                "Hon o yomimashita. Sorekara, bideo o mimashita.",
                "Leí un libro. Después miré un video."
              ],
              [
                "いつも スーパー で かいます。",
                "Itsumo suupaa de kaimasu.",
              ...
              [
                "じゃ、１１じ に えき で あいましょう。",
                "Ja, juuichiji ni eki de aimashou.",
                "Bueno, encontrémonos a las 11 en la estación."
              ]
            ]
          }
        ]
