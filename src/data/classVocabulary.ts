...
export const classVocabCategories: ClassVocabCategory[] = [
  {
    ...
    entries: [
      ...
      { id: 'aula-shukudai', kanji: '宿題', kana: 'しゅくだい', romaji: 'shukudai', es: 'tarea', classes: [1, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      { id: 'exp-hai', kana: 'はい', romaji: 'hai', es: 'sí', classes: [1, 2, 20] },
      { id: 'exp-iie', kana: 'いいえ', romaji: 'iie', es: 'no', classes: [1, 2, 20] },
      ...
      { id: 'exp-nanimo', kana: 'なにも', romaji: 'nani mo', es: 'nada', note: '⚠️ Siempre con el verbo en negativo: なにも しません。', classes: [20] },
      { id: 'exp-darenimo', kana: 'だれにも', romaji: 'dare ni mo', es: 'con nadie / a nadie', note: '⚠️ Siempre con el verbo en negativo: だれにも あいませんでした。', classes: [20] },
    ],
  },
  {
    id: 'personas',
    ...
    entries: [
      ...
      { id: 'per-dare', kanji: '誰', kana: 'だれ', romaji: 'dare', es: '¿quién?', classes: [2, 5, 20] },
      ...
      { id: 'per-tomodachi', kanji: '友達', kana: 'ともだち', romaji: 'tomodachi', es: 'amigo/a', classes: [16, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      { id: 'pais-nihon', kanji: '日本', kana: 'にほん', romaji: 'nihon', es: 'Japón', classes: [1, 20] },
      { id: 'pais-aruzenchin', kana: 'アルゼンチン', romaji: 'aruzenchin', es: 'Argentina', classes: [1, 20] },
      { id: 'pais-chuugoku', kanji: '中国', kana: 'ちゅうごく', romaji: 'chuugoku', es: 'China', classes: [1] },
      { id: 'pais-kankoku', kanji: '韓国', kana: 'かんこく', romaji: 'kankoku', es: 'Corea', classes: [1, 20] },
      { id: 'pais-burajiru', kana: 'ブラジル', romaji: 'burajiru', es: 'Brasil', classes: [1, 20] },
      ...
      { id: 'pais-itaria', kana: 'イタリア', romaji: 'itaria', es: 'Italia', classes: [1, 20] },
      ...
      { id: 'pais-nihongo', kanji: '日本語', kana: 'にほんご', romaji: 'nihongo', es: 'japonés (idioma)', classes: [5, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'hob-shashin', kanji: '写真', kana: 'しゃしん', romaji: 'shashin', es: 'fotografía', note: 'しゃしん を とります — sacar una foto.', classes: [1, 19, 20] },
      { id: 'hob-eiga', kanji: '映画', kana: 'えいが', romaji: 'eiga', es: 'películas', classes: [1, 19, 20, 21] },
      { id: 'hob-ongaku', kanji: '音楽', kana: 'おんがく', romaji: 'ongaku', es: 'música', classes: [1, 19, 20] },
      { id: 'hob-ryouri', kanji: '料理', kana: 'りょうり', romaji: 'ryouri', es: 'cocinar', classes: [1] },
      { id: 'hob-geemu', kana: 'ゲーム', romaji: 'geemu', es: 'videojuegos', classes: [1, 14, 20] },
      { id: 'hob-piano', kana: 'ピアノ', romaji: 'piano', es: 'piano', classes: [1] },
      { id: 'hob-tenisu', kana: 'テニス', romaji: 'tenisu', es: 'tenis', classes: [14, 19, 21] },
      { id: 'hob-sakkaa', kana: 'サッカー', romaji: 'sakkaa', es: 'fútbol', classes: [19, 20, 21] },
      ...
      { id: 'hob-konsaato', kana: 'コンサート', romaji: 'konsaato', es: 'recital / concierto', classes: [20, 21] },
    ],
  },
  {
    id: 'objetos',
    ...
    entries: [
      ...
      { id: 'obj-hon', kanji: '本', kana: 'ほん', romaji: 'hon', es: 'libro', classes: [4, 6, 19, 20, 21] },
      ...
      { id: 'obj-zasshi', kanji: '雑誌', kana: 'ざっし', romaji: 'zasshi', es: 'revista', classes: [2, 4, 6, 20] },
      { id: 'obj-konpyuutaa', kana: 'コンピューター', romaji: 'konpyuutaa', es: 'computadora', classes: [4, 6] },
      { id: 'obj-kaban', kana: 'かばん', romaji: 'kaban', es: 'bolso / mochila / valija', classes: [4, 6, 20] },
      { id: 'obj-kagi', kanji: '鍵', kana: 'かぎ', romaji: 'kagi', es: 'llave', classes: [4, 5, 6] },
      { id: 'obj-koohii', kana: 'コーヒー', romaji: 'koohii', es: 'café', classes: [4, 6, 19, 20, 21] },
      { id: 'obj-kamera', kana: 'カメラ', romaji: 'kamera', es: 'cámara', classes: [4, 6] },
      { id: 'obj-terebi', kana: 'テレビ', romaji: 'terebi', es: 'televisión', classes: [4, 6, 19, 20, 21] },
      { id: 'obj-tsukue', kanji: '机', kana: 'つくえ', romaji: 'tsukue', es: 'escritorio', classes: [4, 6] },
      { id: 'obj-shinbun', kanji: '新聞', kana: 'しんぶん', romaji: 'shinbun', es: 'diario / periódico', classes: [4, 6, 19, 20] },
      ...
      { id: 'obj-kutsu', kanji: '靴', kana: 'くつ', romaji: 'kutsu', es: 'zapatos', classes: [20] },
      { id: 'obj-shatsu', kana: 'シャツ', romaji: 'shatsu', es: 'camisa', classes: [20] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'lug-shokudou', kanji: '食堂', kana: 'しょくどう', romaji: 'shokudou', es: 'comedor', classes: [8, 20, 21] },
      { id: 'lug-toshokan', kanji: '図書館', kana: 'としょかん', romaji: 'toshokan', es: 'biblioteca', classes: [8, 16, 20, 21] },
      ...
      { id: 'lug-eigakan', kanji: '映画館', kana: 'えいがかん', romaji: 'eigakan', es: 'cine', classes: [8, 9, 20, 21] },
      { id: 'lug-depaato', kana: 'デパート', romaji: 'depaato', es: 'tienda por departamentos', classes: [8, 16, 20, 21] },
      ...
      { id: 'lug-kaisha', kanji: '会社', kana: 'かいしゃ', romaji: 'kaisha', es: 'empresa / oficina', classes: [8, 16, 20, 21] },
      ...
      { id: 'lug-kouen', kanji: '公園', kana: 'こうえん', romaji: 'kouen', es: 'parque / plaza', classes: [8, 20] },
      ...
      { id: 'lug-uchi', kanji: '家', kana: 'うち', romaji: 'uchi', es: 'casa', classes: [5, 8, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      { id: 'tie-kyou', kanji: '今日', kana: 'きょう', romaji: 'kyou', es: 'hoy', classes: [10, 13, 16, 20, 21] },
      { id: 'tie-kinou', kanji: '昨日', kana: 'きのう', romaji: 'kinou', es: 'ayer', classes: [10, 13, 16, 20, 21] },
      { id: 'tie-ashita', kanji: '明日', kana: 'あした', romaji: 'ashita', es: 'mañana', classes: [10, 13, 16, 20, 21] },
      ...
      { id: 'tie-ban', kanji: '晩', kana: 'ばん', romaji: 'ban', es: 'tarde / noche', classes: [10, 20] },
      { id: 'tie-yoru', kanji: '夜', kana: 'よる', romaji: 'yoru', es: 'noche', classes: [10, 21] },
      { id: 'tie-kesa', kanji: '今朝', kana: 'けさ', romaji: 'kesa', es: 'esta mañana', classes: [10, 13, 16, 20] },
      ...
      { id: 'tie-mainichi', kanji: '毎日', kana: 'まいにち', romaji: 'mainichi', es: 'todos los días', note: '⚠️ Nunca lleva に.', classes: [10, 13, 16, 20] },
      ...
      { id: 'tie-gozen', kanji: '午前', kana: 'ごぜん', romaji: 'gozen', es: 'AM', note: 'Va antes de la hora.', classes: [11, 13, 20] },
      { id: 'tie-gogo', kanji: '午後', kana: 'ごご', romaji: 'gogo', es: 'PM', classes: [11, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      { id: 'ver-okiru', kanji: '起きる', kana: 'おきる', romaji: 'okiru', es: 'levantarse', note: 'Grupo 2 → おきます.', classes: [13, 14, 20, 21] },
      { id: 'ver-neru', kanji: '寝る', kana: 'ねる', romaji: 'neru', es: 'dormir', note: 'Grupo 2 → ねます.', classes: [13, 14, 20] },
      { id: 'ver-taberu', kanji: '食べる', kana: 'たべる', romaji: 'taberu', es: 'comer', note: 'Grupo 2 → たべます. Lleva を: ごはん を たべます。', classes: [14, 19, 20, 21] },
      { id: 'ver-miru', kanji: '見る', kana: 'みる', romaji: 'miru', es: 'mirar', note: 'Grupo 2 → みます. Lleva を: えいが を みます。', classes: [14, 19, 20, 21] },
      ...
      { id: 'ver-hataraku', kanji: '働く', kana: 'はたらく', romaji: 'hataraku', es: 'trabajar', note: 'Grupo 1 → はたらきます.', classes: [13, 14, 20, 21] },
      { id: 'ver-owaru', kanji: '終わる', kana: 'おわる', romaji: 'owaru', es: 'terminar', note: 'Grupo 1 → おわります.', classes: [13, 14, 20] },
      { id: 'ver-yasumu', kanji: '休む', kana: 'やすむ', romaji: 'yasumu', es: 'descansar', note: 'Grupo 1 → やすみます.', classes: [13, 14, 20] },
      ...
      { id: 'ver-kaku', kanji: '書く', kana: 'かく', romaji: 'kaku', es: 'escribir', note: 'Grupo 1 → かきます. También se usa para dibujar: え を かきます。', classes: [14, 19, 20, 21] },
      { id: 'ver-yomu', kanji: '読む', kana: 'よむ', romaji: 'yomu', es: 'leer', note: 'Grupo 1 → よみます.', classes: [19, 20, 21] },
      ...
      { id: 'ver-kiku', kanji: '聞く', kana: 'きく', romaji: 'kiku', es: 'escuchar', note: 'Grupo 1 → ききます. Lleva を: おんがく を ききます。', classes: [14, 19, 20, 21] },
      { id: 'ver-nomu', kanji: '飲む', kana: 'のむ', romaji: 'nomu', es: 'beber', note: 'Grupo 1 → のみます. Lleva を: みず を のみます。', classes: [14, 19, 20, 21] },
      { id: 'ver-kau', kanji: '買う', kana: 'かう', romaji: 'kau', es: 'comprar', note: 'Grupo 1 → かいます.', classes: [19, 20, 21] },
      { id: 'ver-au', kanji: '会う', kana: 'あう', romaji: 'au', es: 'encontrarse con alguien', note: '⚠️ Grupo 1 → あいます. La persona lleva に, no を: ともだち に あいます。', classes: [20, 21] },
      { id: 'ver-toru', kanji: '撮る', kana: 'とる', romaji: 'toru', es: 'sacar (foto) / grabar (video)', note: '⚠️ Termina en る pero es grupo 1 → とります.', classes: [19, 20] },
      { id: 'ver-suu', kanji: '吸う', kana: 'すう', romaji: 'suu', es: 'inhalar / fumar', note: 'Grupo 1 → すいます. タバコ を すいます。', classes: [19, 20] },
      { id: 'ver-asobu', kanji: '遊ぶ', kana: 'あそぶ', romaji: 'asobu', es: 'jugar', note: 'Grupo 1 → あそびます.', classes: [14] },
      { id: 'ver-iku', kanji: '行く', kana: 'いく', romaji: 'iku', es: 'ir', note: 'Grupo 1 → いきます.', classes: [15, 16, 20, 21] },
      ...
      { id: 'ver-suru', kana: 'する', romaji: 'suru', es: 'hacer', note: 'Grupo 3 (irregular) → します. Convierte sustantivos en acciones.', classes: [14, 19, 20, 21] },
      { id: 'ver-kuru', kanji: '来る', kana: 'くる', romaji: 'kuru', es: 'venir', note: 'Grupo 3 (irregular) → きます.', classes: [14, 15] },
      { id: 'ver-benkyou-suru', kanji: '勉強する', kana: 'べんきょうする', romaji: 'benkyou suru', es: 'estudiar', note: 'Compuesto con する.', classes: [13, 14, 19, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      { id: 'tra-hikouki', kanji: '飛行機', kana: 'ひこうき', romaji: 'hikouki', es: 'avión', classes: [16, 20] },
      { id: 'tra-shinkansen', kanji: '新幹線', kana: 'しんかんせん', romaji: 'shinkansen', es: 'tren bala', classes: [16] },
      { id: 'tra-densha', kanji: '電車', kana: 'でんしゃ', romaji: 'densha', es: 'tren', classes: [16, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'com-asagohan', kanji: '朝ご飯', kana: 'あさごはん', romaji: 'asagohan', es: 'desayuno', note: 'あさ + ごはん.', classes: [19, 20] },
      { id: 'com-hirugohan', kanji: '昼ご飯', kana: 'ひるごはん', romaji: 'hirugohan', es: 'almuerzo', note: 'ひる + ごはん.', classes: [19, 20, 21] },
      { id: 'com-bangohan', kanji: '晩ご飯', kana: 'ばんごはん', romaji: 'bangohan', es: 'cena', note: 'ばん + ごはん.', classes: [19, 21] },
      { id: 'com-pan', kana: 'パン', romaji: 'pan', es: 'pan', classes: [19, 20, 21] },
      ...
      { id: 'com-sakana', kanji: '魚', kana: 'さかな', romaji: 'sakana', es: 'pescado', classes: [19, 20] },
      { id: 'com-yasai', kanji: '野菜', kana: 'やさい', romaji: 'yasai', es: 'verduras', classes: [19] },
      { id: 'com-kudamono', kanji: '果物', kana: 'くだもの', romaji: 'kudamono', es: 'frutas', classes: [19, 20] },
      ...
      { id: 'com-sushi', kana: 'すし', romaji: 'sushi', es: 'sushi', classes: [20] },
      { id: 'com-piza', kana: 'ピザ', romaji: 'piza', es: 'pizza', classes: [20] },
      { id: 'com-kimuchi', kana: 'キムチ', romaji: 'kimuchi', es: 'kimchi', classes: [20] },
      { id: 'com-hanbaagaa', kana: 'ハンバーガー', romaji: 'hanbaagaa', es: 'hamburguesa', classes: [20, 21] },
      { id: 'com-raamen', kana: 'ラーメン', romaji: 'raamen', es: 'ramen', classes: [20, 21] },
    ],
  },
  {
    id: 'bebidas',
    ...
    entries: [
      { id: 'beb-mizu', kanji: '水', kana: 'みず', romaji: 'mizu', es: 'agua', classes: [19, 20, 21] },
      { id: 'beb-ocha', kanji: 'お茶', kana: 'おちゃ', romaji: 'ocha', es: 'té verde', classes: [19, 20, 21] },
      ...
      { id: 'beb-juusu', kana: 'ジュース', romaji: 'juusu', es: 'jugo', classes: [19, 20] },
      { id: 'beb-biiru', kana: 'ビール', romaji: 'biiru', es: 'cerveza', classes: [19, 21] },
      { id: 'beb-osake', kanji: 'お酒', kana: 'おさけ', romaji: 'osake', es: 'sake / bebida alcohólica', note: 'Con お es cualquier alcohol; sin お, el sake de arroz.', classes: [19, 20, 21] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'med-anime', kana: 'アニメ', romaji: 'anime', es: 'anime', classes: [19, 20] },
      { id: 'med-dorama', kana: 'ドラマ', romaji: 'dorama', es: 'serie / novela', classes: [19, 20] },
  ...
  },
  {
    ...
    entries: [
      { id: 'lec-tegami', kanji: '手紙', kana: 'てがみ', romaji: 'tegami', es: 'carta', classes: [19, 20] },
      ...
      { id: 'lec-manga', kana: 'まんが', romaji: 'manga', es: 'manga', classes: [19, 20] },
    ],
  },
  {
    id: 'naturaleza',
