// Vocabulario REAL de la cursada: lo visto en las clases 1–16 (content/clases/*.md)
...
export const classVocabCategories: ClassVocabCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'exp-soudesune', kana: 'そうですね', romaji: 'sou desu ne', es: 'sí, es cierto / pues sí', classes: [] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'hob-e', kanji: '絵', kana: 'え', romaji: 'e', es: 'dibujo / pintura', classes: [1] },
      { id: 'hob-shashin', kanji: '写真', kana: 'しゃしん', romaji: 'shashin', es: 'fotografía', classes: [1] },
      { id: 'hob-eiga', kanji: '映画', kana: 'えいが', romaji: 'eiga', es: 'películas', classes: [1] },
      { id: 'hob-ongaku', kanji: '音楽', kana: 'おんがく', romaji: 'ongaku', es: 'música', classes: [1] },
      ...
      { id: 'hob-tenisu', kana: 'テニス', romaji: 'tenisu', es: 'tenis', classes: [14] },
    ],
  },
  {
    id: 'objetos',
    ...
    entries: [
      { id: 'obj-jisho', kanji: '辞書', kana: 'じしょ', romaji: 'jisho', es: 'diccionario', classes: [4, 6] },
      { id: 'obj-kasa', kanji: '傘', kana: 'かさ', romaji: 'kasa', es: 'paraguas', classes: [4, 6] },
      { id: 'obj-hon', kanji: '本', kana: 'ほん', romaji: 'hon', es: 'libro', classes: [4, 6] },
      ...
      { id: 'obj-koohii', kana: 'コーヒー', romaji: 'koohii', es: 'café', classes: [4, 6] },
      { id: 'obj-kamera', kana: 'カメラ', romaji: 'kamera', es: 'cámara', classes: [4, 6] },
      { id: 'obj-terebi', kana: 'テレビ', romaji: 'terebi', es: 'televisión', classes: [4, 6] },
      { id: 'obj-tsukue', kanji: '机', kana: 'つくえ', romaji: 'tsukue', es: 'escritorio', classes: [4, 6] },
      { id: 'obj-shinbun', kanji: '新聞', kana: 'しんぶん', romaji: 'shinbun', es: 'diario / periódico', classes: [4, 6] },
      ...
      { id: 'obj-rajio', kana: 'ラジオ', romaji: 'rajio', es: 'radio', classes: [4, 6] },
      ...
      { id: 'obj-omiyage', kanji: 'お土産', kana: 'おみやげ', romaji: 'omiyage', es: 'souvenir / regalo típico', classes: [4, 6] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'ver-taberu', kanji: '食べる', kana: 'たべる', romaji: 'taberu', es: 'comer', note: 'Grupo 2 → たべます.', classes: [14] },
      { id: 'ver-miru', kanji: '見る', kana: 'みる', romaji: 'miru', es: 'mirar', note: 'Grupo 2 → みます.', classes: [14] },
      ...
      { id: 'ver-kaku', kanji: '書く', kana: 'かく', romaji: 'kaku', es: 'escribir', note: 'Grupo 1 → かきます.', classes: [14] },
      ...
      { id: 'ver-kiku', kanji: '聞く', kana: 'きく', romaji: 'kiku', es: 'escuchar', note: 'Grupo 1 → ききます.', classes: [14] },
      { id: 'ver-nomu', kanji: '飲む', kana: 'のむ', romaji: 'nomu', es: 'beber', note: 'Grupo 1 → のみます.', classes: [14] },
      ...
      { id: 'ver-suru', kana: 'する', romaji: 'suru', es: 'hacer', note: 'Grupo 3 (irregular) → します.', classes: [14] },
      { id: 'ver-kuru', kanji: '来る', kana: 'くる', romaji: 'kuru', es: 'venir', note: 'Grupo 3 (irregular) → きます.', classes: [14, 15] },
      { id: 'ver-benkyou-suru', kanji: '勉強する', kana: 'べんきょうする', romaji: 'benkyou suru', es: 'estudiar', note: 'Compuesto con する.', classes: [13, 14] },
      { id: 'ver-souji-suru', kanji: '掃除する', kana: 'そうじする', romaji: 'souji suru', es: 'limpiar', classes: [14] },
      { id: 'ver-denwa-suru', kanji: '電話する', kana: 'でんわする', romaji: 'denwa suru', es: 'llamar por teléfono', classes: [14] },
    ],
  },
  {
    id: 'transporte',
