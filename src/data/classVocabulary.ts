// Vocabulario REAL de la cursada: lo visto en las clases 1–19 (content/clases/*.md)
...
export const classVocabCategories: ClassVocabCategory[] = [
  {
    ...
    entries: [
      ...
      { id: 'aula-wakarimashita', kana: 'わかりました', romaji: 'wakarimashita', es: 'entendí', classes: [1] },
      { id: 'aula-wakarimasen', kana: 'わかりません', romaji: 'wakarimasen', es: 'no entiendo', classes: [1] },
      { id: 'aula-shukudai', kanji: '宿題', kana: 'しゅくだい', romaji: 'shukudai', es: 'tarea', classes: [1] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'sal-sumimasen', kana: 'すみません', romaji: 'sumimasen', es: 'perdón / disculpe', note: 'También para llamar la atención y para agradecer una molestia.', classes: [1, 3] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'exp-chotto', kana: 'ちょっと', romaji: 'chotto', es: 'un momento / un poco', classes: [2] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'per-tomodachi', kanji: '友達', kana: 'ともだち', romaji: 'tomodachi', es: 'amigo/a', classes: [16] },
      ...
      { id: 'per-hitori', kanji: '一人', kana: 'ひとり', romaji: 'hitori', es: 'una sola persona / solo', note: 'Lleva で, no と: ひとり で いきます。', classes: [16] },
    ],
  },
  {
    id: 'paises',
    ...
    entries: [
      ...
      { id: 'pais-nihongo', kanji: '日本語', kana: 'にほんご', romaji: 'nihongo', es: 'japonés (idioma)', classes: [5] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'hob-eiga', kanji: '映画', kana: 'えいが', romaji: 'eiga', es: 'películas', classes: [1, 19] },
      ...
      { id: 'hob-tenisu', kana: 'テニス', romaji: 'tenisu', es: 'tenis', classes: [14, 19] },
      { id: 'hob-sakkaa', kana: 'サッカー', romaji: 'sakkaa', es: 'fútbol', classes: [19] },
      ...
      { id: 'hob-sanpo', kanji: '散歩', kana: 'さんぽ', romaji: 'sanpo', es: 'paseo', classes: [19] },
    ],
  },
  {
    id: 'objetos',
    ...
    entries: [
      ...
      { id: 'obj-hon', kanji: '本', kana: 'ほん', romaji: 'hon', es: 'libro', classes: [4, 6, 19] },
      ...
      { id: 'obj-koohii', kana: 'コーヒー', romaji: 'koohii', es: 'café', classes: [4, 6, 19] },
      { id: 'obj-kamera', kana: 'カメラ', romaji: 'kamera', es: 'cámara', classes: [4, 6] },
      { id: 'obj-terebi', kana: 'テレビ', romaji: 'terebi', es: 'televisión', classes: [4, 6, 19] },
      ...
      { id: 'obj-rajio', kana: 'ラジオ', romaji: 'rajio', es: 'radio', classes: [4, 6, 19] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'lug-shokudou', kanji: '食堂', kana: 'しょくどう', romaji: 'shokudou', es: 'comedor', classes: [8] },
      { id: 'lug-toshokan', kanji: '図書館', kana: 'としょかん', romaji: 'toshokan', es: 'biblioteca', classes: [8, 16] },
      ...
      { id: 'lug-resutoran', kana: 'レストラン', romaji: 'resutoran', es: 'restaurante', classes: [8] },
      ...
      { id: 'lug-eigakan', kanji: '映画館', kana: 'えいがかん', romaji: 'eigakan', es: 'cine', classes: [8, 9] },
      { id: 'lug-depaato', kana: 'デパート', romaji: 'depaato', es: 'tienda por departamentos', classes: [8, 16] },
      { id: 'lug-bijutsukan', kanji: '美術館', kana: 'びじゅつかん', romaji: 'bijutsukan', es: 'museo de arte', classes: [8, 16] },
      { id: 'lug-minato', kanji: '港', kana: 'みなと', romaji: 'minato', es: 'puerto', classes: [8] },
      { id: 'lug-kaisha', kanji: '会社', kana: 'かいしゃ', romaji: 'kaisha', es: 'empresa / oficina', classes: [8, 16] },
      ...
      { id: 'lug-eki', kanji: '駅', kana: 'えき', romaji: 'eki', es: 'estación', classes: [8] },
      { id: 'lug-apaato', kana: 'アパート', romaji: 'apaato', es: 'departamento', classes: [8] },
      { id: 'lug-suupaa', kana: 'スーパー', romaji: 'suupaa', es: 'supermercado', classes: [8, 16] },
      { id: 'lug-biru', kana: 'ビル', romaji: 'biru', es: 'edificio', classes: [8] },
      { id: 'lug-uchi', kanji: '家', kana: 'うち', romaji: 'uchi', es: 'casa', classes: [5, 8] },
      ...
      { id: 'lug-daigaku', kanji: '大学', kana: 'だいがく', romaji: 'daigaku', es: 'universidad', classes: [8, 9] },
      { id: 'lug-gakkou', kanji: '学校', kana: 'がっこう', romaji: 'gakkou', es: 'escuela', classes: [15] },
      ...
      { id: 'lug-hanaya', kanji: '花屋', kana: 'はなや', romaji: 'hanaya', es: 'floristería', classes: [9] },
      { id: 'lug-youfukuya', kanji: '洋服屋', kana: 'ようふくや', romaji: 'youfukuya', es: 'tienda de ropa', classes: [9] },
      { id: 'lug-panya', kanji: 'パン屋', kana: 'ぱんや', romaji: 'panya', es: 'panadería', classes: [9] },
  ...
  },
  {
    ...
    entries: [
      { id: 'tie-kyou', kanji: '今日', kana: 'きょう', romaji: 'kyou', es: 'hoy', classes: [10, 13, 16] },
      { id: 'tie-kinou', kanji: '昨日', kana: 'きのう', romaji: 'kinou', es: 'ayer', classes: [10, 13, 16] },
      { id: 'tie-ashita', kanji: '明日', kana: 'あした', romaji: 'ashita', es: 'mañana', classes: [10, 13, 16] },
      { id: 'tie-asatte', kanji: '明後日', kana: 'あさって', romaji: 'asatte', es: 'pasado mañana', classes: [10, 13] },
      { id: 'tie-ototoi', kanji: '一昨日', kana: 'おととい', romaji: 'ototoi', es: 'anteayer', classes: [10, 13, 16] },
      ...
      { id: 'tie-raishuu', kanji: '来週', kana: 'らいしゅう', romaji: 'raishuu', es: 'la semana que viene', classes: [10, 16] },
      ...
      { id: 'tie-yoru', kanji: '夜', kana: 'よる', romaji: 'yoru', es: 'noche', classes: [10] },
      { id: 'tie-kesa', kanji: '今朝', kana: 'けさ', romaji: 'kesa', es: 'esta mañana', classes: [10, 13, 16] },
      { id: 'tie-konban', kanji: '今晩', kana: 'こんばん', romaji: 'konban', es: 'esta noche', classes: [10] },
      ...
      { id: 'tie-kinyoubi', kanji: '金曜日', kana: 'きんようび', romaji: 'kinyoubi', es: 'viernes', note: '金 = Oro.', classes: [12] },
      { id: 'tie-doyoubi', kanji: '土曜日', kana: 'どようび', romaji: 'doyoubi', es: 'sábado', note: '土 = Suelo.', classes: [12] },
      { id: 'tie-nichiyoubi', kanji: '日曜日', kana: 'にちようび', romaji: 'nichiyoubi', es: 'domingo', note: '日 = Sol.', classes: [12] },
      { id: 'tie-gozen', kanji: '午前', kana: 'ごぜん', romaji: 'gozen', es: 'AM', note: 'Va antes de la hora.', classes: [11, 13] },
      { id: 'tie-gogo', kanji: '午後', kana: 'ごご', romaji: 'gogo', es: 'PM', classes: [11] },
      { id: 'tie-han', kanji: '半', kana: 'はん', romaji: 'han', es: 'y media', note: 'くじはん — 9 y media.', classes: [11] },
  ...
  },
  {
    ...
    entries: [
      { id: 'ver-okiru', kanji: '起きる', kana: 'おきる', romaji: 'okiru', es: 'levantarse', note: 'Grupo 2 → おきます.', classes: [13, 14] },
      { id: 'ver-neru', kanji: '寝る', kana: 'ねる', romaji: 'neru', es: 'dormir', note: 'Grupo 2 → ねます.', classes: [13, 14] },
      { id: 'ver-taberu', kanji: '食べる', kana: 'たべる', romaji: 'taberu', es: 'comer', note: 'Grupo 2 → たべます. Lleva を: ごはん を たべます。', classes: [14, 19] },
      { id: 'ver-miru', kanji: '見る', kana: 'みる', romaji: 'miru', es: 'mirar', note: 'Grupo 2 → みます. Lleva を: えいが を みます。', classes: [14, 19] },
      ...
      { id: 'ver-hataraku', kanji: '働く', kana: 'はたらく', romaji: 'hataraku', es: 'trabajar', note: 'Grupo 1 → はたらきます.', classes: [13, 14] },
      ...
      { id: 'ver-kaku', kanji: '書く', kana: 'かく', romaji: 'kaku', es: 'escribir', note: 'Grupo 1 → かきます. También se usa para dibujar: え を かきます。', classes: [14, 19] },
      { id: 'ver-yomu', kanji: '読む', kana: 'よむ', romaji: 'yomu', es: 'leer', note: 'Grupo 1 → よみます.', classes: [19] },
      ...
      { id: 'ver-kiku', kanji: '聞く', kana: 'きく', romaji: 'kiku', es: 'escuchar', note: 'Grupo 1 → ききます. Lleva を: おんがく を ききます。', classes: [14, 19] },
      { id: 'ver-nomu', kanji: '飲む', kana: 'のむ', romaji: 'nomu', es: 'beber', note: 'Grupo 1 → のみます. Lleva を: みず を のみます。', classes: [14, 19] },
      { id: 'ver-kau', kanji: '買う', kana: 'かう', romaji: 'kau', es: 'comprar', note: 'Grupo 1 → かいます.', classes: [19] },
      ...
      { id: 'ver-iku', kanji: '行く', kana: 'いく', romaji: 'iku', es: 'ir', note: 'Grupo 1 → いきます.', classes: [15, 16] },
      ...
      { id: 'ver-suru', kana: 'する', romaji: 'suru', es: 'hacer', note: 'Grupo 3 (irregular) → します. Convierte sustantivos en acciones.', classes: [14, 19] },
      { id: 'ver-kuru', kanji: '来る', kana: 'くる', romaji: 'kuru', es: 'venir', note: 'Grupo 3 (irregular) → きます.', classes: [14, 15] },
      { id: 'ver-benkyou-suru', kanji: '勉強する', kana: 'べんきょうする', romaji: 'benkyou suru', es: 'estudiar', note: 'Compuesto con する.', classes: [13, 14, 19] },
      ...
      { id: 'ver-kaimono-suru', kanji: '買い物する', kana: 'かいものする', romaji: 'kaimono suru', es: 'hacer las compras', classes: [19] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'tra-densha', kanji: '電車', kana: 'でんしゃ', romaji: 'densha', es: 'tren', classes: [16] },
      ...
      { id: 'tra-aruite', kanji: '歩いて', kana: 'あるいて', romaji: 'aruite', es: 'caminando / a pie', note: '⚠️ Es la excepción: NO lleva で.', classes: [16] },
    ],
  },
  {
    id: 'comida',
    ...
    entries: [
      ...
      { id: 'com-hirugohan', kanji: '昼ご飯', kana: 'ひるごはん', romaji: 'hirugohan', es: 'almuerzo', note: 'ひる + ごはん.', classes: [19] },
      { id: 'com-bangohan', kanji: '晩ご飯', kana: 'ばんごはん', romaji: 'bangohan', es: 'cena', note: 'ばん + ごはん.', classes: [19] },
      { id: 'com-pan', kana: 'パン', romaji: 'pan', es: 'pan', classes: [19] },
      { id: 'com-tamago', kanji: '卵', kana: 'たまご', romaji: 'tamago', es: 'huevo', classes: [19] },
      { id: 'com-niku', kanji: '肉', kana: 'にく', romaji: 'niku', es: 'carne', classes: [19] },
  ...
  },
  {
    ...
    entries: [
      { id: 'beb-mizu', kanji: '水', kana: 'みず', romaji: 'mizu', es: 'agua', classes: [19] },
      { id: 'beb-ocha', kanji: 'お茶', kana: 'おちゃ', romaji: 'ocha', es: 'té verde', classes: [19] },
      { id: 'beb-koucha', kanji: '紅茶', kana: 'こうちゃ', romaji: 'koucha', es: 'té negro', classes: [19] },
      { id: 'beb-gyuunyuu', kanji: '牛乳', kana: 'ぎゅうにゅう', romaji: 'gyuunyuu', es: 'leche', classes: [19] },
      { id: 'beb-juusu', kana: 'ジュース', romaji: 'juusu', es: 'jugo', classes: [19] },
      { id: 'beb-biiru', kana: 'ビール', romaji: 'biiru', es: 'cerveza', classes: [19] },
      { id: 'beb-osake', kanji: 'お酒', kana: 'おさけ', romaji: 'osake', es: 'sake / bebida alcohólica', note: 'Con お es cualquier alcohol; sin お, el sake de arroz.', classes: [19] },
  ...
  },
  {
    ...
    entries: [
      { id: 'med-bangumi', kanji: '番組', kana: 'ばんぐみ', romaji: 'bangumi', es: 'programa de TV', classes: [19] },
      ...
      { id: 'med-bideo', kana: 'ビデオ', romaji: 'bideo', es: 'video', classes: [19] },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'lec-repooto', kana: 'レポート', romaji: 'repooto', es: 'informe', classes: [19] },
